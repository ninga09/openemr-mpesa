...
function CheckVisible(MakeBlank)
 ...
 //In edit its value should not be lost on just a change.It is controlled be the 'MakeBlank' argument.
   ...
   {
    document.getElementById('mpesa_phone_row').style.display='';
    document.getElementById('mpesa_pay_button').style.display='inline-block';
   }
   else
   {
    document.getElementById('mpesa_phone_row').style.display='none';
    document.getElementById('mpesa_pay_button').style.display='none';
    if(MakeBlank=='yes')
     {
        document.getElementById('mpesa_phone').value='';
        document.getElementById('mpesa_status').innerHTML='';
     }
   }
 }
