...
?>
  ...
  <td colspan='3' nowrap style='font-size:8pt'>
   &nbsp;
    ...
    <tr>
        <td align="left" class="forms"><?php echo xlt('Presenting Complain(s)'); ?>:</td>
    ...
    <tr>
        <td align="left" class="forms"><?php echo xlt('History of Presenting Illness'); ?>:</td>
