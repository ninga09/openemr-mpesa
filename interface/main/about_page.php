...
<head>
    ...
    <title><?php echo xl("About");?> Z-E.M.R</title>
    <style>
        .donations-needed {
            margin-top: 25px;
            margin-bottom: 25px;
        ...
        <div class="row">
            <div class="col-xs-12 col-md-4 col-md-offset-4 text-center">
                <div class="page-header">
                    <h2><?php echo xlt("");?>&nbsp;Z-HEALTHCARE SYSTEM</h2>
                </div>
                <h3><?php  echo xlt('Version Number'); ?>: <?php echo "v".text($openemr_version) ?></h3>
                ...
                <?php if (!empty($GLOBALS['support_phone_number'])) { ?>
                    <span class="text"><?php  echo xlt('Support Telephone'); ?>: <?php echo $GLOBALS['support_phone_number'] ?></span><br>
                <?php } ?>
                <a href="<?php echo "#".attr($version->getMajor()).".".attr($version->getMinor()).".".attr($version->getPatch())."_Users_Guide"; ?>" target="_blank" class="btn btn-block btn-default"><i class="fa fa-fw fa-book"></i>&nbsp;<?php echo xlt('User Manual'); ?></a>
                <?php if (!empty($GLOBALS['online_support_link'])) { ?>
                    <a href='<?php echo $GLOBALS["#"]; ?>' target="_blank" class="btn btn-default btn-block"><i class="fa fa-fw fa-question-circle"></i>&nbsp;<?php echo xlt('Online Support'); ?></a>
                <?php } ?>
                ...
                <div class="donations-needed">
                    <span class="text"><?php echo xlt("Please consider Supporting"); ?> ZONIROH TECHNOLOGIES:</span><br>
                    <a href="http://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=V6EVVTYYK264C" target="_blank" class="btn btn-lg btn-block"><i class="fa fa-2x fa-heart"></i><br/><?php echo xlt("24/7, Z-EMR"); ?></a>
                </div>
            </div>
        </div>
