...
<table width="1024" border="0" cellspacing="0" cellpadding="10" bgcolor="#DEDEDE"><tr><td>
    <table width="1004" border="0" style="border:1px solid black" cellspacing="0" cellpadding="0">
      ...
      <tr id="mpesa_phone_row" style="display:none;">
        <td align="left" class="text"></td>
        <td align="left" class="text"><?php echo htmlspecialchars(xl('Phone Number'), ENT_QUOTES).':' ?></td>
        <td align="left"><input type="text" name="mpesa_phone" id="mpesa_phone" placeholder="0712345678" autocomplete="off" value="" style="width:140px" class="text" /></td>
        <td></td>
        <td></td>
        <td align="left" class="text"><?php echo htmlspecialchars(xl('Pay with M-Pesa'), ENT_QUOTES).':' ?></td>
        <td align="left"><button type="button" id="mpesa_pay_button" onclick="initiateMpesaPayment()" class="css_button" style="display:none;"><span><?php echo htmlspecialchars(xl('Pay Now'), ENT_QUOTES);?></span></button></td>
        <td></td>
        <td></td>
        <td align="left" class="text"><div id="mpesa_status" style="color: green;"></div></td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
